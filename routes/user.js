  ...
  .post(async (req, res) => {
    ...
    try {
      if (usersData.username) {
        ...
        if (updatedInfo) {
          return res.render("profilePage/profile", {message: 'Username Updated'});
        }
        ...
        if (updatedInfo) {
          return res.render("profilePage/profile", {message: 'State Updated'});
        }
        ...
        if (updatedInfo) {
          return res.render("profilePage/profile", {message: 'Password Updated'});
        }
      }
    } catch (e) {
